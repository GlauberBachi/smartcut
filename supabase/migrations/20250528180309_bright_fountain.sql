/*
  ...
  1. Changes
    - Remove transaction handling that was causing issues
    - Keep proper error logging
    - Ensure all records are created in the correct order
    - Create temporary Stripe records that will be updated later
