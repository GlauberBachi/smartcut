...
import { Trash2, User, Camera, Key, CreditCard } from 'lucide-react';
    ...
    <div className="py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow">
          <div className="p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Perfil do Usuário</h2>
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h4 className="text-lg font-medium text-gray-900">Plano atual</h4>
                <div className="mt-4">
            ...
            <div className="mb-8">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                <h4 className="text-lg font-medium text-red-800 mb-4">Excluir Conta</h4>
